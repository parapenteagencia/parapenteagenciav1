$(function() {
	...
	$('.contact-form').on("submit", function(){
		...
		var msg = 'Los siguientes campos deben ser completados correctamente:',
			successMessage = "Tu correo es mu importante para nosotros. Uno de nuestros colaboradores se pondra en contacto pronto contigo.",
			error = 0,
